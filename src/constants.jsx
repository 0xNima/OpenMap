...
export const POI_NOTIFICATION_DELAY = 60000;
export const COLLAPSED = 0
export const LAYERS_SUB_MENU = 1
export const POIS_SUB_MENU = 2
export const DRAWING_SUB_MENU = 3
export const GEODATA_SUB_MENU = 4
export const RASTER_SUB_MENU = 5